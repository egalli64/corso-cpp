 ...
 *
 * A derived class meant _not_ to be derived
 */
#ifndef CORSO_CPP_B7_S2_EXTENDED_ENTRY_H
#define CORSO_CPP_B7_S2_EXTENDED_ENTRY_H
...
#endif // CORSO_CPP_B7_S2_EXTENDED_ENTRY_H
